                ...
                <div className="col-lg-12 col-md-12 col-sm-12 top-section" >
                    <div className="app-header-segment">
                        {window.innerWidth < 500 ? <div className={cx(
                            ...
                            <div className="col-lg-3 col-md-3 col-sm-2 app-header-left">
                            ...
                            <div className={cx(
                                ...
                                <div className="col-lg-9 col-md-9 col-sm-3 app-header-right">
                                    <ul className="app-header-right-list">
                                        ...
                                        <li><Link to='/law-school/settings'><i className="pe-7s-settings"></i></Link></li>
                                        <li>
                                        ...
                                        <li><Link to='/law-school/get-help'><div className="get-help">GET HELP</div></Link></li>
