...
export default class Meesages extends React.Component {
    constructor(props) {
        super(props);
                    ...
                    >
                        <Row>
                            <Col lg="12">
                                ...
                                <Card tabs="true" className="mb-3">
                                    <CardHeader style={{ height: `${60 + this.state.customFontSize}px` }}>
                                        <Nav justified>
                                            ...
                                            <NavItem style={{ fontSize: `${14 + this.state.customFontSize}px` }}>
                                                <NavLink
                                                    href="javascript:void(0);"
                                                    className={classnames({
                                                    ...
                                                    <Row>
                                                        <Col xs="6">
                                                            <div class="custom-checkbox custom-control mt-4 mb-4 ml-3">
                                                                ...
                                                                />
                                                                <label class="custom-control-label" for="selectAll" style={{ fontSize: `${14 + this.state.customFontSize}px` }}> &nbsp; Select All </label>
                                                            </div>
                                                        </Col>
                                                        <Col xs="6">
                                                            {this.state.show && (
                                                                <div className="text-right">
                                                                    <Button className="mt-3 mb-3 mr-1 btn-icon markAsUnread" id="mySelect" onClick={this.markAsRead} style={{ fontSize: `${14 + this.state.customFontSize}px` }}>
                                                    ...
                                                    <Col className="message-border" key={index}>
                                                        <Row>
                                                            <Col md="3" sm="12">
                                                                <div className="p-3 mt-3 mb-3">
                                                                    <div class="custom-checkbox custom-control">
                                                                        ...
                                                                        {/* {this.state.show && ( */}
                                                                        <a style={{ fontSize: `${14 + this.state.customFontSize}px` }} href="javascript:void(0);"
                                                                            onClick={() => {
                                                                        ...
                                                                        ><FontAwesomeIcon
                                                                            ...
                                                                            /></a>
                                                                        {/* )} */}
                                                                        <span className="ml-3 name" style={{ fontSize: `${14 + this.state.customFontSize}px` }}>
                                                                            {foreachitem.name}
                                                            ...
                                                            <Col md="9" sm="12">
                                                                ...
                                                                >
                                                                    <a href="#/law-school/messages" style={{ fontSize: `${14 + this.state.customFontSize}px` }}>{foreachitem.fullMessage}</a>
                                                                </div>
                                                        ...
                                                        <Row>
                                                            ...
                                                            <Col md="9" sm="12">
                                                                <div className="p-3 mt-2 mb-2 message archive-message" style={this.state.myStyle} >
                                                                    <a href="#/students/messages" onClick={this.toggleMessageArchive.bind(this, index)} style={{ fontSize: `${14 + this.state.customFontSize}px` }}>{foreachitem.fullMessage}</a>
                                                                </div>
                                                                {/* {this.state.selectedProduct === index ? (
                                <Collapse isOpen={this.state.collapse} className="p-3">
                                  <span>{foreachitem.fullMessage}</span>
                                ...
                                <div className="app-inner-layout__bottom-pane d-block text-center mb-0" style={{ fontSize: `${14 + this.state.customFontSize}px` }}>
                                    <JwPagination
